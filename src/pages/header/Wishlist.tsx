...
const Wishlist: React.FC = () => {
  ...
  return (
    <div className="p-5 md:p-12 font-inter">
      ...
      {data.map((designer) => (
        <div className="my-5 flex flex-col items-center md:flex-row p-6 gap-6 rounded-2xl shadow-custom ">
          <img
            src={designer.img}
            alt=""
          ...
          <div className="flex flex-col">
            ...
            <p className="font-bold text-sm  py-2 leading-4 text-[#531A02]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-5">
                ...
                <div className="flex gap-1 mr-14 text-[#531A02]">
              ...
              <div className="border border-[#531A02] bg-white p-[2px] rounded-full inline-flex items-center justify-center">
                <FaArrowRightLong className="bg-[#531A02] text-white rounded-full p-2 h-8 w-8" />
              </div>
            </div>
          </div>
