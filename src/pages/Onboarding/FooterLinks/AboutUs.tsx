...
import Team2 from "../../../assets/Footer/Team2.png";
import Team3 from "../../../assets/Footer/Team3.png";
import Team4 from "../../../assets/Footer/Team4.png";
import Team5 from "../../../assets/Footer/Team5.png";
import Team6 from "../../../assets/Footer/Team6.png";
import Team7 from "../../../assets/Footer/Team7.png";
import Team8 from "../../../assets/Footer/Team8.png";
...
const items: Item[] = [
  {
    ...
    content:
      "Styler is an innovative platform that bridges the gap between fashion enthusiasts and professional designers, providing a seamless experience for creating bespoke clothing that reflects individual style.",
  },
  {
    id: 2,
    question: "How does Styler work?",
    content:
      "Users can browse profiles of talented designers, share their requirements or inspirations, and collaborate to bring their dream outfits to life through the Styler platform.",
  },
  {
    id: 3,
    question: "Can I order both custom and ready-to-wear garments?",
    content:
      "Yes, Styler offers a dual service model where clients can order custom-made garments as well as choose from a curated collection of ready-to-wear designs.",
  },
  {
    id: 4,
    question: "How do I find a designer?",
    content:
      "You can use the search and filter options on Styler to discover designers based on location, specialization, style, and ratings, ensuring you find the perfect match for your needs.",
  },
];
...
const items2: Item[] = [
  {
    ...
    content:
      "Prices are determined based on the complexity of the design, materials used, and the designer's expertise. Each project includes a transparent pricing breakdown.",
  },
  {
    id: 6,
    question: "How do I communicate with the designer?",
    content:
      "Clients can communicate with designers directly through Styler's built-in messaging system, enabling smooth collaboration and updates throughout the project.",
  },
  {
    id: 7,
    question: "Can I send my own fabric to the designer?",
    content:
      "Yes, clients can send their own fabric to the designer. Details about shipping and handling will be coordinated through Styler to ensure a smooth process.",
  },
  {
    id: 8,
    question: "What are the delivery options?",
    content:
      "Styler offers multiple delivery options, including standard, express, and international shipping. You can choose the option that best suits your timeline and budget.",
  },
  {
    id: 9,
    question: "How do I track my order?",
    content:
      "Once your order is shipped, you will receive a tracking number via email and can monitor the progress of your delivery through Styler's tracking system.",
  },
  {
    id: 10,
    question: "How do I join Styler as a designer?",
    content:
      "Designers can apply to join Styler by submitting their portfolio and credentials through the 'Join Us' section. Approved designers gain access to a global client base.",
  },
  {
    id: 11,
    question: "Is there a minimum order quantity for fabrics?",
    content:
      "The minimum order quantity for fabrics depends on the designer's policy. Clients can discuss and finalize the specifics during the consultation phase.",
  },
];
...
const AboutUs: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero section */}
      <div className="flex flex-col lg:flex-row gap-10 md:gap-16 py-10 px-5 md:px-5 lg:py-16 lg:px-14 bg-[#DEF9FF] w-full">
      ...
      <div className="flex flex-col gap-0  px-5 py-16 lg:px-16 font-inter items-center">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-6 lg:gap-7">
          <div className="flex flex-col gap-3 border">
            <img src={Team1} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              ...
              <p className="text-[#3E3E59] text-sm">
                A passionate developer skilled in writing clean and efficient
                code, Jocelyn always strives to deliver exceptional results with
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team2} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Martin Donin</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Martin loves collaborating on creative solutions and is
                dedicated to building systems that prioritize both performance
                and reliability.
              </p>
              <div className="flex gap-2 pt-2">
                <FiFacebook className="w-10 h-10 p-3 text-white bg-[#025195] rounded-full" />
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team3} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Jordyn Septimus</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Jordyn focuses on creating user-friendly applications, blending
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team4} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Leo Arcand</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                LLeo is driven by a passion for backend development, ensuring
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team5} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Marilyn Levin</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Marilyn brings designs to life with her front-end skills, making
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team6} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Lindsey Dokidis</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Lindsey’s sharp problem-solving skills and attention to detail
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team7} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Hanna Dias</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Hanna is a front-end enthusiast who creates seamless user
          ...
          <div className="flex flex-col gap-3 border">
            <img src={Team8} alt="" className="h-48 w-full object-cover" />
            <div className="flex flex-col p-4 gap-2">
              <h3 className="font-semibold text-lg">Ryan Gouse</h3>
              <p className="text-[#3E3E59] text-sm">Software Engineer</p>
              <p className="text-[#3E3E59] text-sm">
                Ryan specializes in cloud technologies, ensuring every
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
          {items.map((item: Item) => (
            <div
              key={item.id}
              className={`h-fit ${
                isActive(item.id) ? "bg-[#025195] py-6" : "bg-white py-6"
              } rounded-2xl px-4 md:px-6 transition-all duration-300`}
            >
              <div className="flex justify-between items-center">
                <h3
                  className={`text-sm md:text-lg font-semibold ${
                    isActive(item.id) ? "text-white " : "text-[#025195]"
                  } `}
                >
                  {item.question}
                </h3>
                <IoIosArrowForward
                  className={`w-10 h-10 p-3 bg-[#DEF9FF] text-[#025195] ${
                    isActive(item.id) ? " -rotate-90" : ""
              ...
              {isActive(item.id) && (
                <p className="text-white text-xs md:text-base w-4/5 transition-opacity duration-300">
                  {item.content}
                </p>
              )}
            </div>
          ...
          {items2.map((item2: Item) => (
            ...
            >
              <div
                className={`div1 ${
                  isActive(item2.id) ? "bg-[#025195] py-6" : "bg-white py-6"
                } rounded-2xl px-4 md:px-6 transition-all duration-300`}
              >
                <div className="flex justify-between items-center">
                  <h3
                    className={`text-sm md:text-lg font-semibold ${
                      isActive(item2.id) ? "text-white " : "text-[#025195]"
                    } `}
                  >
                    {item2.question}
                  </h3>
