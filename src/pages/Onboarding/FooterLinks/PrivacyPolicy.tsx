    ...
    <div className="flex mt-20 lg:mx-32 md:mx-28 mx-5 gap-10">
        ...
        <ul className="space-y-2">
              ...
              <div
                className={`${
                  activeSection === "Information"
                    ...
                    : "bg-white text-[#025195]"
                } flex rounded-full px-4 py-3 items-center justify-between`}
              >
                <p className=" font-medium">Information We Glean</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Information"
                      ? "bg-white text-[#025195]"
          ...
          <li>
            <a href="#Use">
              ...
              >
                <p className=" font-medium">Our Data Utilization Practices</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Use"
                      ? "bg-white text-[#025195]"
          ...
          <li>
            <a href="#Sharing">
              ...
              >
                <p className=" font-medium">Disclosure of your data</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Sharing"
                      ? "bg-white text-[#025195]"
          ...
          <li>
            <a href="#Rights">
              ...
              >
                <p className=" font-medium"> Your Legal Rights</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Rights"
                      ? "bg-white text-[#025195]"
          ...
          <li>
            <a href="#Cookies">
              ...
              >
                <p className=" font-medium"> Cookies Policy</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Cookies"
                      ? "bg-white text-[#025195]"
      ...
      <div className=" font-inter mb-20">
        ...
        <section id="Protection">
          <h2 className=" font-semibold text-3xl mb-4 mt-7">Data Protection</h2>
          <p className="text-[#546879]">
