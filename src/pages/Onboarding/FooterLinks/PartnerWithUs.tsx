...
const items: Item[] = [
  {
    ...
    content:
      "Partnership business involves joining Styler as a collaborator. Sign up, submit your details and portfolio, and start connecting with clients to showcase and sell your designs.",
  },
  {
    id: 2,
    question: "Is it easy to take numerous orders at once?",
    content:
      "With Styler's order management tools, handling multiple orders is straightforward. You can prioritize tasks, manage deadlines, and track progress efficiently.",
  },
  {
    id: 3,
    question: "What sorts of customers will I work with?",
    content:
      "You will work with a diverse range of customers, from individuals seeking custom designs to businesses needing bulk orders, all through Styler's platform.",
  },
  {
    id: 4,
    question: "What are the financial terms and conditions for a partnership?",
    content:
      "Styler offers transparent financial terms, including commission rates and payment schedules. Detailed terms are provided during the onboarding process.",
  },
];
...
const items2: Item[] = [
  {
    ...
    content:
      "No upfront investment is required. Designers can join Styler without any fees and start earning through commissions on their orders.",
  },
  {
    id: 6,
    question: "How would collaborating with Styler help our business?",
    content:
      "Collaborating with Styler increases your visibility, connects you with global clients, and provides tools to streamline your workflow and grow your business.",
  },
  {
    id: 7,
    question: "How do I get my payments?",
    content:
      "Payments are securely processed and transferred directly to your account. You can track all transactions through your Styler dashboard.",
  },
  {
    id: 8,
    question: "How does Styler handle safety and anonymity?",
    content:
      "Styler ensures client and partner safety by using secure communication channels and protecting personal information with advanced encryption protocols.",
  },
  {
    id: 9,
    question: "How can Styler support our long-term vision?",
    content:
      "Styler helps you achieve your long-term goals by providing a reliable platform, marketing opportunities, and a steady stream of potential clients.",
  },
  {
    id: 10,
    question: "How would Styler help me market my business?",
    content:
      "Styler offers promotional tools, showcases your portfolio to a global audience, and highlights your designs through targeted marketing campaigns.",
  },
  {
    id: 11,
    question: "What happens if a client is not satisfied with their order?",
    content:
      "In case of dissatisfaction, Styler facilitates resolution by mediating between the designer and client to ensure a fair outcome for both parties.",
  },
];
          ...
          <div>
            <div className="rounded-2xl ">
              <img
                src={Partner3}
                alt=""
                className=" w-full z-10 cover rounded-2xl "
              />
            </div>
            <div className="flex flex-col -mt-28  ml-10  z-20  ">
              <h1 className="bg-white pt-5 px-4 rounded-tl-2xl text-[#025195] font-Gloock md:text-xl ">
