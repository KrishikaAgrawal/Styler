        ...
        <ul className="space-y-2">
          ...
          <li>
            <a href="#PaymentServices">
              ...
              >
                <p className=" font-medium"> Payment Services</p>
                <FaChevronRight
                  className={`${
                    activeSection === "PaymentServices"
                      ? "bg-[#025195] text-white"
          ...
          <li>
            <a href="#Cancellation">
              ...
              >
                <p className=" font-medium">Cancellation and Rescheduling</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Cancellation"
                      ? "bg-[#025195] text-white"
          ...
          <li>
            <a href="#Return">
              ...
              >
                <p className=" font-medium">Return and Refund Policy</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Return"
                      ? "bg-[#025195] text-white"
          ...
          <li>
            <a href="#Responsibilities">
              ...
              >
                <p className=" font-medium">User Responsibilities</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Responsibilities"
                      ? "bg-[#025195] text-white"
          ...
          <li>
            <a href="#Limitations">
              ...
              >
                <p className=" font-medium">Service Limitations</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Limitations"
                      ? "bg-[#025195] text-white"
          ...
          <li>
            <a href="#Liability">
              ...
              >
                <p className=" font-medium">Liability and Dispute Reputation</p>
                <FaChevronRight
                  className={`${
                    activeSection === "Liability"
                      ? "bg-[#025195] text-white"
