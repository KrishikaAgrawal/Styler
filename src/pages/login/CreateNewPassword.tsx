...
const CreateNewPassword: React.FC = () => {
  ...
  return (
    <div className=" md:flex justify-center items-center lg:h-screen bg-[#F4F0F0] ">
      <div className="flex flex-col md:h-fit p-5 lg:w-2/3 md:flex-row bg-white gap-5 lg:gap-8 lg:border md:rounded-2xl lg:shadow-2xl ">
        {/* Page image */}
        <div className="flex flex-col  ">
          <div className="flex gap-4 lg:pb-5 items-center">
            ...
            <p className="text-2xl font-bold">Create New Password</p>
          </div>

          <div className="md:flex flex-col h-[400px] hidden ">
            <img
              src={SignupImg}
              alt=""
