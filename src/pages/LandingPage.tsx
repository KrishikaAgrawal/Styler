...
import brownArrow from "../assets/LandingPage/brownArrow.png";
    ...
    <div className="overflow-x-hidden">
      ...
      <div className=" my-16 md:mx-16">
        ...
        <div className="my-4 mx-2 md:mx-0 font-Gloock flex justify-between items-center">
          ...
          <div className=" text-st-dark-brown text-xs  ">Today, Morning</div>
        </div>
        <div className="flex text-white bg-[#5A3F2C] md:rounded-xl py-6 md:px-14 px-4 font-Gloock justify-between">
        ...
        <div className="flex flex-col lg:flex-row  gap-8 md:rounded-2xl bg-[#F4F0F0] mt-16 py-16 items-center justify-center ">
          <div className="w-full px-4 lg:px-16 lg:w-1/2">
            <h1 className="mb-6 font-Gloock text-3xl ">
              Why <span className="text-[#531A02] ">Styler.</span>
            </h1>
            <h2 className="mb-6 text-[#531A02] font-Gloock text-5xl">
            ...
            <div className="md:absolute bottom-32 left-64 w-64 bg-white flex p-4 gap-3 rounded-2xl">
              ...
              <div className="flex flex-col">
                ...
                <p className="font-medium text-sm my-2">
                  <span className="text-[#531A02]">40% &nbsp;</span>completed
                </p>
                <div className="w-36 rounded-full h-1 bg-[#F4F0F0]">
                  <div className="w-2/5 rounded-full h-1 bg-[#531A02]"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Our Designers */}
        <h1 className="text-[#531A02] lg:text-6xl md:text-5xl text-4xl font-Gloock flex justify-center my-8 md:my-12 lg:my-16">
          OUR DESIGNERS
        </h1>
        <div>
          <Slider {...settings1} className="">
            {data.map((designer) => (
              <div className=" p-3 rounded-2xl border border-black">
                ...
                />
                <h1 className="mb-2 mt-4 leading-none text-2xl text-[#531A02] font-Gloock ">
                  {designer.name}
                </h1>
                <p className=" font-medium text-sm text-[#531A02]">
                  {designer.loc}
                </p>
                <p className="font-bold leading-4 py-2 text-sm text-[#531A02]">
                  {designer.specH}
                  <span className="font-normal text-[#7C7C7C]">
                    {designer.spec}
                  </span>
                </p>
                <p className="font-bold text-sm leading-4 text-[#531A02]">
                  {designer.serviceH}
                  <span className="font-normal text-[#7C7C7C]">
                    {designer.service}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-1 mr-14">
                    <img className="w-4 h-4" src={designer.star} alt="" />
                    <img className="w-4 h-4" src={designer.star} alt="" />
                    <img className="w-4 h-4" src={designer.star} alt="" />
                    <img className="w-4 h-4" src={designer.star_half} alt="" />
                  </div>
                  <div className="border border-[#531A02] bg-white p-[2px] rounded-full inline-flex items-center justify-center">
                    <img
                      className="bg-[#531A02] rounded-full p-1 h-8"
                      src={designer.arrow}
                      alt=""
                    />
                  </div>
              ...
              <div className=" p-3 rounded-2xl border border-black">
                ...
                <div className="flex items-center mb-2 mt-4 justify-between">
                  ...
                  <div className="flex gap-1 mr-6">
                    <img className="w-4 h-4" src={popular.star} alt="" />
                    <img className="w-4 h-4" src={popular.star} alt="" />
                    <img className="w-4 h-4" src={popular.star} alt="" />
                    <img className="w-4 h-4" src={popular.star_half} alt="" />
                  </div>
                </div>
            ...
            {data2.map((service) => (
              <div className=" p-3 rounded-2xl border border-black">
                ...
                <div className="flex  mt-4 items-center justify-between">
                  <h1 className=" leading-none text-3xl lg:text-4xl text-[#531A02] font-Gloock  ">
                    {service.name}
                  </h1>
                ...
                <div className="flex items-center my-3 justify-between">
                  <p className="   px-8 py-2 rounded-lg text-[#531A02] border border-[#531A02] bg-[#FCEBE0] font-bold">
                    {service.loc}
                  </p>
                  <div className="flex items-center gap-1">
                    <img src={service.locLogo} alt="" className="w-7" />
                    <div className="font-bold text-[#5A3F2C] text-lg">
                      {service.dist}
                    </div>
                  </div>
                </div>
                <p className="font-bold leading-4 text-sm text-[#531A02]">
                  {service.specH}
                  <span className="font-normal text-[#7C7C7C]">
                    {service.spec}
                  </span>
                </p>
                <p className="font-bold text-sm leading-4 my-3 text-[#531A02]">
                  {service.servicesH}
                  <span className="font-normal text-[#7C7C7C]">
                    {service.services}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex gap-3">
                    ...
                    <div className="flex gap-1 mr-14">
                      <img className="w-5 h-5" src={service.star} alt="" />
                      <img className="w-5 h-5" src={service.star} alt="" />
                      <img className="w-5 h-5" src={service.star} alt="" />
                      <img className="w-5 h-5" src={service.star_half} alt="" />
                    </div>
                  </div>
                  <div className="border border-[#531A02] bg-white p-[2px] rounded-full inline-flex items-center justify-center">
                    <img
                      className="bg-[#531A02] rounded-full p-2 h-8 w-8 md:h-10 md:w-10"
                      src={service.arrow}
                      alt=""
                    />
                  </div>
        ...
        <div className="flex flex-col md:flex-row bg-[#531A02]  px-10 pt-10 md:px-14 md:pt-14 text-white  gap-10 md:rounded-[30px] my-12">
        ...
        <div className=" flex flex-col-reverse md:flex-row m-5 md:m-0 gap-12 md:items-center ">
          <div className="md:w-1/2">
            <div className="flex gap-3">
              ...
              <div className=" flex flex-col gap-3">
                <div className="flex w-full items-center justify-around py-5 text-white rounded-xl bg-[#5A3F2C]">
          ...
          <div className="flex md:w-1/2 flex-col gap-5">
            ...
            <p className="text-3xl md:text-4xl font-bold overflow">
              Your journey to{" "}
              <span className="text-[#531A02]">PERSONALIZED FASHION</span>{" "}
              starts here.
            </p>
            ...
            <button className="inline-flex font-semibold mt-6 w-fit rounded-full items-center justify-center px-8 md:px-16 py-4 border-[#531A02] text-[#531A02] border gap-3">
              <p>Read More</p>
