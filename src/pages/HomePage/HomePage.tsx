  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="min-h-screen flex flex-col">
        {/* hero section */}
        <div className="flex-grow bg-[#F3FDFF] flex p-5 gap-5 md:gap-10 md:p-20 lg:gap-40 lg:p-20">
        ...
        {/* WHY CHOOSE US*/}
        <div className="flex md:px-16 lg:px-20 lg:py-16 md:py-12 py-8 flex-col-reverse md:flex-row px-5 md:m-0 gap-12 md:items-center bg-[#F3FDFF]">
          <div className="md:w-1/2">
